...
public class Producto {
	...
	public String toString() {
		return "Producto [codProducto=" + codProducto + ", nombreProducto=" + nombreProducto
				+ ", unidadMedidaProductoString=" + unidadMedidaProductoString + ", precioProducto=" + precioProducto
