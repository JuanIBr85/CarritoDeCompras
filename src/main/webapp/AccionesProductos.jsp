	...
	<div class="container">
		...
		<div class="form-container">
			...
			<form action="ProductoControllers" method="post">
				...
				<div class="mb-3">
					<label for="CodProducto" class="form-label">Código del
						Producto:</label> <input type="text" id="CodProducto" name="CodProducto"
						class="form-control" required />
				</div>
				<div class="mb-3">
					<label for="NombreProducto" class="form-label">Nombre del
						Producto:</label> <input type="text" id="NombreProducto"
						name="NombreProducto" class="form-control" required />
				</div>
				<div class="mb-3">
					<label for="UnidadMedidaProducto" class="form-label">Unidad
						de Medida:</label> <input type="text" id="UnidadMedidaProducto"
						name="UnidadMedidaProducto" class="form-control" required />
				</div>
				<div class="mb-3">
					<label for="PrecioProducto" class="form-label">Precio del
						Producto:</label> <input type="number" id="PrecioProducto"
						name="PrecioProducto" step="0.01" class="form-control" required />
				</div>
				<div class="mb-3">
					<label for="StockProducto" class="form-label">Stock
						Inicial:</label> <input type="number" id="StockProducto"
						name="StockProducto" class="form-control" required />
				</div>
				<button type="submit" class="btn btn-custom w-100">Dar de
					alta</button>
			</form>
		</div>
...
<form action="ProductoControllers" method="post">
    ...
    <!-- Permitir la edición del código del producto -->
    <div class="mb-3">
    ...
    <button type="submit" class="btn btn-custom w-100">Actualizar Producto</button>
		...
		<div class="my-2 text-center">
			<a href="ProductoControllers?accion=ListaProductos"
				class="btn btn-outline-primary">Listado de Productos</a>
		</div>
	</div>
</body>
</html>
